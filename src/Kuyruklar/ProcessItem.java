...
public class ProcessItem {
	...
	public ProcessItem(int oncelik, int gelisSuresi, int processSuresi, int mbyts, int prn, int scn, int modem, int cd, Renkler renk) {
	...
	public String Mesaj() {
		return String.format("(id:%d öncelik:%d kalan süre:%d sn MBytes: %d prn: %d scn: %d modem: %d cd: %d )", id,oncelik, kalanSure, mbyts, prn, scn, modem, cd);
	}
